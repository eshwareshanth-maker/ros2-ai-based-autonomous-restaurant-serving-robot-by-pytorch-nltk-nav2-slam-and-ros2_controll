...
: ${AMENT_CURRENT_PREFIX:="/home/vboxuser/res_robo/src/install/restaurant_bot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/restaurant_bot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/restaurant_bot/environment/path.sh"
